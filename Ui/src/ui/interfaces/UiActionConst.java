...
public interface UiActionConst {
    public final static String BLACK = "BLACK";
    public final static String NEUTRAL = "";
    public final static String FLIPPED = "V";
    public final static String NOT_FLIPPED = "X";
    public final static String MENU_SAVE = "Save menu on exit";
    public final static String MENU_ON = "On";
    public final static String MENU_OFF = "Off";
    public final static int NEUTRAL_MAX_NAME_LENGTH = 5;
    public final static int IDENTIFICATION_LINE_ADDONS_SIZE = 7; //using -"[]  ()"
